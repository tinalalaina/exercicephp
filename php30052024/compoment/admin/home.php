...
<br/><br/>
<a class="btn btn-outline-success" type="submit" href="../createprojetprt.php">Crée un évènement</a>
<br/><br/>
<center>
<div class="row align-items-center">
  ...
  <?php while ($ET=mysqli_fetch_assoc($result)){?>
    <div class="col-6">
       <br/>
       <br/>
    <img src="../../assets/sary/<?php echo ($ET['photo'])?>" alt="" class="img-thumbnail" alt="..." style="height: auto;">
    ...
    <p style="color:white;text-shadow: 2px 2px 5px black;" > <?php echo ($ET['commentaire'])?> </p>
       ...
       <br/>
       <a href="voirplus.php?code=<?php echo ($ET['code'])?>" class="btn btn-outline-primary"style='margin:0px 3px 3px;'><i class="fas fa-plus-circle"></i><br> </a>
       <a href="editeradminlistepr.php?code=<?php echo ($ET['code'])?>" class="btn btn-outline-secondary"style='margin:0px 3px 3px;'><i class="fas fa-sync"></i><br> </a>
       <a href="supprimer.php?code=<?php echo ($ET['code'])?>" class="btn btn-outline-danger"style='margin:0px 3px 3px;'><i class="fas fa-trash-alt"></i><br> </a>
